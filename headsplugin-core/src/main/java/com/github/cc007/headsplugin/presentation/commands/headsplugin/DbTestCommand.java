...
public class DbTestCommand extends AbstractCommand {
    ...
    private final HeadToItemstackMapper headToItemstackMapper;
    ...
    public DbTestCommand(Context context,
        ...
        this.headToItemstackMapper = headToItemstackMapper;
    ...
    public void run() {
        ...
        for (Category category : categories) {
            ...
            if (optionalHead.isPresent()) {
                ...
                showInfo(head);
                ItemStack headIS = headToItemstackMapper.getItemStack(head);
